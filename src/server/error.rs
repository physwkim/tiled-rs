...
impl From<crate::core::queries::UnsupportedQuery> for ServerError {
    fn from(err: crate::core::queries::UnsupportedQuery) -> Self {
...
impl From<crate::core::queries::QueryDecodeError> for ServerError {
    fn from(err: crate::core::queries::QueryDecodeError) -> Self {
...
impl From<crate::core::TiledError> for ServerError {
    fn from(err: crate::core::TiledError) -> Self {
        match err {
            crate::core::TiledError::NotFound(msg) => Self::NotFound(msg),
            crate::core::TiledError::Validation(msg) => Self::Validation(msg),
            ...
            crate::core::TiledError::UnsupportedQuery(msg) => Self::UnsupportedQuery(msg),
            crate::core::TiledError::UnsupportedMediaType(msg) => Self::UnsupportedMediaType(msg),
            // A write that conflicts with existing state (e.g. a duplicate
            // ragged chunk_index) → 409, parity with Python tiled's `Conflicts`.
            crate::core::TiledError::Conflict(msg) => Self::Conflict(msg),
            crate::core::TiledError::Internal(msg) => Self::Internal(msg),
