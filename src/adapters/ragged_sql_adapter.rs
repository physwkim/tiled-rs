...
//! produces ([`crate::serialization::ragged::BufferMap`]), so the wire protocol
...
use crate::core::structures::{RaggedStructure, Spec, StructureFamily};
use crate::serialization::ragged::{
    BufferMap, awkward_form_json, buffers_to_json, expected_from_buffers, json_to_buffers,
};

use crate::adapters::ragged_adapter::{RaggedAdapter, json_leaf_count};
...
impl RaggedSqlStore {
    ...
    /// names (e.g. from [`crate::serialization::ragged::expected_from_buffers`]).
...
/// table. The ragged analog of [`crate::adapters::init_storage_npy`]: it places a
