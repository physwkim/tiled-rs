...
use crate::core::dtype::{BuiltinDType, DynNDArray};
...
impl ArrayAdapter {
    ...
    pub fn from_array(
        ...
        let structure = ArrayStructure {
            data_type: crate::core::dtype::DType::Builtin(dtype),
            chunks,
            shape,
            dims: None,
    ...
    pub fn from_f64_1d(data: &[f64], metadata: serde_json::Value) -> Self {
        ...
        let dtype = BuiltinDType::new(
            crate::core::dtype::Endianness::Little,
            crate::core::dtype::Kind::Float,
            8,
        );
        Self::from_array(
            Bytes::from(bytes),
