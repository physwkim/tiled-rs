...
impl DynNDArray {
    ...
    /// and `Ellipsis`.
    pub fn apply_slice(&self, slice: &crate::core::ndslice::NDSlice) -> Result<Self> {
        use crate::core::ndslice::SliceDim;
...
fn expand_slice_dims(
    slice: &crate::core::ndslice::NDSlice,
    ndim: usize,
) -> Result<Vec<crate::core::ndslice::SliceDim>> {
    use crate::core::ndslice::SliceDim;
