...
use tiled_core::adapters::{AwkwardAdapterRead, AwkwardAdapterWrite, BaseAdapter, BoxFuture};
use tiled_core::error::Result;
use tiled_core::structures::{AwkwardStructure, Spec, StructureFamily};
...
mod tests {
    use super::*;
    use tiled_core::adapters::{AwkwardAdapterRead, BaseAdapter};
    use tiled_core::structures::{AwkwardStructure, StructureFamily};
