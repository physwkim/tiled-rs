...
mod tests {
    ...
    use tiled_core::adapters::{BaseAdapter, TableAdapterRead};
    ...
    fn empty_paths_is_error() {
        ...
        assert!(
            matches!(err, tiled_core::error::TiledError::Validation(_)),
    ...
    fn missing_file_is_error() {
        ...
        .unwrap_err();
        assert!(
            matches!(err, tiled_core::error::TiledError::Internal(_)),
