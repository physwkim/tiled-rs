...
//!
//! Re-exports all query types from [`tiled_core::queries`]. Pass any [`Query`]
//! to [`ContainerClient::search`](crate::ContainerClient::search) to filter
...
//!
//! ```no_run
//! use tiled_client::queries::{FullText, Key, Query, Regex, StructureFamily, StructureFamilyQuery};
...
pub use tiled_core::structures::StructureFamily;
